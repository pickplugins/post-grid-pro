...
addFilter("termsQueryPrams", "post-grid/termList", function (options) {
...
addFilter("postGridDateCountdownStartDate", "post-grid/date-countdown", function (options) {
...
addFilter("postGridDateCountdownEndDate", "post-grid/date-countdown", function (options) {
...
addFilter("postGridFeaturedImageTitleText", "post-grid/post-featured-image", function (options) {
...
addFilter("postGridPostCommentCountIconPosition", "post-grid/post-comment-count", function (options) {
...
addFilter("postGridPostCommentCountLinkTo", "post-grid/post-comment-count", function (options) {
...
addFilter("postGridWooProductInfoElementsArgs", "post-grid/woo-product-info", function (options) {
...
addFilter("postGridPostExcerptLinkTo", "post-grid/post-excerpt", function (options) {
...
addFilter("postGridPostExcerptReadMoreLinkTo", "post-grid/post-excerpt", function (options) {
...
addFilter("postGridTermsListIconPosition", "post-grid/terms-list", function (options) {
...
addFilter("postGridTermsQueryItemLinkTo", "post-grid/terms-query-item", function (options) {
...
addFilter("postGridTermsQueryTermField", "post-grid/terms-query-item", function (options) {
...
addFilter("postGridPostTitleLinkTo", "post-grid/post-title", function (options) {
...
addFilter("postGridPostTitleLimitBy", "post-grid/post-title", function (options) {
...
addFilter("postGridPostCategoriesIconPosition", "post-grid/post-categories", function (options) {
...
addFilter("postGridPostCategoriesLinkTo", "post-grid/post-categories", function (options) {
...
addFilter("postGridNumberCounterSource", "post-grid/number-counter", function (options) {
...
addFilter("postGridBreadcrumbElementsSource", "post-grid/breadcrumb", function (options) {
...
addFilter("postGridProgressBarSource", "post-grid/progress-bar", function (options) {
