    ...
    <div class="item">
        ...
        <div class="element-options options">
            ...
            $args = array(
                ...
                'parent' => $input_name.'[cmb2_image]',
                'title'		=> __('Wrapper html','post-grid'),
                'details'	=> __('Write wrapper html, use <code>%s</code> to replace output. ex: <code>Value: %s</code>,<br> Return type: File URL<br> <code>Image link: &lt;a href="%s">Click to Download&lt;/a> </code>, image <code>&lt;img src="%s"/> </code> ','post-grid'),
                'type'		=> 'text',
                'value'		=> $wrapper_html,
                'default'		=> '',
                'placeholder'		=> 'Image: %s',
...
function post_grid_layout_element_cmb2_image($args){
    ...
    if(!empty($cmb2_value)):
        ...
        ?>
        <div class="element element_<?php echo esc_attr($elementIndex); ?> <?php echo esc_attr($custom_class); ?> cmb2_image ">
            <?php echo ($cmb2_value); ?>
        </div>
    <?php
    endif;
...
function post_grid_layout_element_option_cmb2_file($parameters){
    ...
    $meta_key = isset($element_data['meta_key']) ? $element_data['meta_key'] : '';
    $wrapper_html = isset($element_data['wrapper_html']) ? $element_data['wrapper_html'] : '%s';
    $item_wrapper_html = isset($element_data['item_wrapper_html']) ? $element_data['item_wrapper_html'] : '%s';
    ...
    <div class="item">
        ...
        <div class="element-options options">
            ...
            $args = array(
                ...
                'css_id'		=> $element_index.'_item_wrapper_html',
                'parent' => $input_name.'[cmb2_file]',
                'title'		=> __('Item wrapper html','post-grid'),
                'details'	=> __('Write item wrapper html, use <code>%s</code> to replace output. ex: <code>Value: %s</code>,<br> Return type: File URL<br> <code>File: &lt;a href="%s">Click to view&lt;/a> </code> <br> <code>Image HTML: &lt;img src="%s"/> </code> ','post-grid'),
                'type'		=> 'text',
...
function post_grid_layout_element_cmb2_file($args){
    ...
    if(!empty($cmb2_value)):
        ...
        if(is_array($cmb2_value)){
            ...
            foreach ($cmb2_value as $value){
                //var_dump($value);

                $html .= sprintf($item_wrapper_html, $value);
            }
    ...
    <div class="item">
        ...
        <div class="element-options options">
            ...
            $args = array(
                ...
                'parent' => $input_name.'[cmb2_select]',
                'title'		=> __('Wrapper html','post-grid'),
                'details'	=> __('Write wrapper html, use <code>%s</code> to replace output. ex: <code>Value: %s</code>, <code>Values: %s</code>','post-grid'),
                'type'		=> 'text',
                'value'		=> $wrapper_html,
                'default'		=> '',
                'placeholder'		=> 'Value: %s',
    ...
    <div class="item">
        ...
        <div class="element-options options">
            ...
            $args = array(
                ...
                'parent' => $input_name.'[cmb2_checkbox]',
                'title'		=> __('Item wrapper html','post-grid'),
                'details'	=> __('Write item wrapper html, use <code>%s</code> to replace output. for single, <code>Is checked: Yes</code> for multi: list item ex: <code>&lt;li>%s&lt;/li></code>','post-grid'),
                'type'		=> 'text',
                'value'		=> $item_wrapper_html,
                'default'		=> '',
                'placeholder'		=> 'Value: %s',
